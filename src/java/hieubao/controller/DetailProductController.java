...
public class DetailProductController extends HttpServlet {
    ...
    public final String UPDATE_SUCCESS = "ManageProductController";
    public final String UPDATE_ERROR = "error.html";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ProductDTO detailProduct = new ProductDTO(id, idCategory, name, image, Double.parseDouble(price), dateCreate, description);
